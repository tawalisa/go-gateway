...
// Server defines backend server structure
type Server struct {
	URL    string
	Weight int
}

// LoadBalancer defines the load balancer interface
...
// ChooseServer randomly chooses a server
...
// ChooseServer weighted round-robin selects a server
